...
public class lot2 extends AppCompatActivity implements ApiResponse{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        space1 = findViewById(R.id.lot2space1);
        space2 = findViewById(R.id.lot2space2);
        space3 = findViewById(R.id.lot2space3);
    ...
    public void processResult(String output){
        try {
            ...
            space1status = jsonArray.getJSONArray(0).getString(4);
            space2status = jsonArray.getJSONArray(1).getString(4);
            space3status = jsonArray.getJSONArray(2).getString(4);
